...
-(TextView *)textView{
    if (!_textView) {
        _textView =[[TextView alloc]initWithFrame:CGRectMake(self.h_margin, self.v_margin, self.frame.size.width - 2 *self.h_margin,  self.initiLine *self.font.lineHeight)];

...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/04023401/objectCCategory.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "objectCCategory", "objectCCategory/utils/**/*.{h,m}"
